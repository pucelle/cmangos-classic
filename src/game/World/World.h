...
enum eConfigUInt32Values
{
    ...
    CONFIG_GAME_ENHANCE_MAIL_UNTIL_EXPIRED_DAYS,
    CONFIG_GAME_ENHANCE_MAIL_MAX_COUNT,
...
enum eConfigFloatValues
{
    ...
    CONFIG_GAME_ENHANCE_HUNTER_PET_RARE_GAIN_STAT_RATE,
    CONFIG_GAME_ENHANCE_WARLOCK_PET_DAMAGE_BONUS_RATE,
    CONFIG_GAME_ENHANCE_MAGE_PET_DAMAGE_BONUS_RATE,
    CONFIG_GAME_ENHANCE_PET_GAIN_STAT_RATE,
    CONFIG_GAME_ENHANCE_PET_GAIN_ATTACK_POWER_RATE,
    CONFIG_GAME_ENHANCE_PET_GAIN_CRITICAL_RATE,
    CONFIG_GAME_ENHANCE_PET_GAIN_DODGE_RATE,
    CONFIG_GAME_ENHANCE_RESTORE_HEALTH_RATE_IN_COMBAT,
    CONFIG_GAME_ENHANCE_RESTORE_HEALTH_RATE_WHEN_SIT,
    CONFIG_GAME_ENHANCE_CRIT_FROM_AGILITY_RATE,
    CONFIG_GAME_ENHANCE_DODGE_FROM_AGILITY_RATE,
    CONFIG_GAME_ENHANCE_SPELL_CRIT_FROM_INTELLECT_RATE,
    CONFIG_GAME_ENHANCE_HP_REGENT_PER_SPIRIT,
    CONFIG_GAME_ENHANCE_MP_REGENT_PER_SPIRIT,
    CONFIG_GAME_ENHANCE_MINIMUM_MANA_REGEN_RATE,
    CONFIG_GAME_ENHANCE_BASE_MELEE_HIT_CHANCE,
    CONFIG_GAME_ENHANCE_BASE_MELEE_DODGE_CHANCE,
    CONFIG_GAME_ENHANCE_BASE_MELEE_PARRY_CHANCE,
    CONFIG_GAME_ENHANCE_BASE_MELEE_BLOCK_CHANCE,
    CONFIG_GAME_ENHANCE_BASE_SPELL_HIT_CHANCE,
    CONFIG_GAME_ENHANCE_SPELL_CRITIAL_BONUS_RATE,
    CONFIG_GAME_ENHANCE_LOW_HIT_CHANCE_REDUCE_PER_LEVEL,
    CONFIG_GAME_ENHANCE_HIGH_HIT_CHANCE_REDUCE_PER_LEVEL,
    CONFIG_GAME_ENHANCE_OFFHAND_HIT_CHANCE_REDUCE,
    CONFIG_GAME_ENHANCE_OFFHAND_DAMAGE_RATE,
    CONFIG_GAME_ENHANCE_SPELL_TRIGGER_CHANCE_RATE,
    CONFIG_GAME_ENHANCE_RARE_RESPAWN_TIME_RATE,
    CONFIG_GAME_ENHANCE_DUNGEON_5MAN_CREATURE_HEALTH_RATE,
    CONFIG_GAME_ENHANCE_DUNGEON_5MAN_CREATURE_DAMAGE_RATE,
    CONFIG_GAME_ENHANCE_DUNGEON_10MAN_CREATURE_HEALTH_RATE,
    CONFIG_GAME_ENHANCE_DUNGEON_10MAN_CREATURE_DAMAGE_RATE,
    CONFIG_GAME_ENHANCE_DUNGEON_15MAN_CREATURE_HEALTH_RATE,
    CONFIG_GAME_ENHANCE_DUNGEON_15MAN_CREATURE_DAMAGE_RATE,
    CONFIG_GAME_ENHANCE_DUNGEON_20MAN_CREATURE_HEALTH_RATE,
    CONFIG_GAME_ENHANCE_DUNGEON_20MAN_CREATURE_DAMAGE_RATE,
    CONFIG_GAME_ENHANCE_DUNGEON_40MAN_CREATURE_HEALTH_RATE,
    CONFIG_GAME_ENHANCE_DUNGEON_40MAN_CREATURE_DAMAGE_RATE,
    CONFIG_GAME_ENHANCE_BATTLE_GROUND_WAIT_TIME_RATE,
...
enum eConfigBoolValues
{
    ...
    CONFIG_GAME_ENHANCE_HUNTER_PET_KEEPS_ARMOR,
    CONFIG_GAME_ENHANCE_HUNTER_PET_KEEPS_SIZE,
    CONFIG_GAME_ENHANCE_HUNTER_PET_KEEPS_RESISTANCE,
    CONFIG_GAME_ENHANCE_DOT_GAIN_FROM_CRITICAL,
    CONFIG_GAME_ENHANCE_ACCOUNT_SHARES_RIDING_SKILLS,
    CONFIG_GAME_ENHANCE_ACCOUNT_SHARES_PROFESSION_SKILLS,
    CONFIG_GAME_ENHANCE_BALANCE_DROP_GROUP,
    CONFIG_GAME_ENHANCE_ACCOUNT_SHARES_FINDING_TREASURE,
    CONFIG_GAME_ENHANCE_MAIL_CAN_SEND_TO_SELF,
    CONFIG_GAME_ENHANCE_FULL_XP_GAIN_IN_GROUP,
    CONFIG_GAME_ENHANCE_WORLD_BUFF_APPLY_TO_PET,
    CONFIG_GAME_ENHANCE_PET_WORLD_BUFF_NOT_CONSUME_AFTER_LOGOUT,
